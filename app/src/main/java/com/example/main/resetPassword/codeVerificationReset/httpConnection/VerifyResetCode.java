...
import com.example.main.resetPassword.codeVerificationReset.apiServices.ApiCodeVerificationReset;
...
public class VerifyResetCode {
    ...
    public VerifyResetCode(ResetPresenter presenter, String codeNumber, String phoneNumber, String accessToken) {
...
//
        ...
        ApiCodeVerificationReset apiCodeVerificationReset = retrofit.create(ApiCodeVerificationReset.class);
        AccessToken token = new AccessToken(accessToken);
        // start asking
        Call<Message> call = apiCodeVerificationReset.verifyCode("Bearer " + token.getToken(), code);
